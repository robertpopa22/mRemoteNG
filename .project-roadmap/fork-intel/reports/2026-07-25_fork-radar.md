...
### `691476fe7f` Fix connection tree jumping to a random "...Research" connection

- **fork:** [k-meeks/mRemoteNG](https://github.com/mRemoteNG/mRemoteNG/commit/691476fe7fede603caf1ce1dd0249c0f17507901) by Kyle Meeks
- **size:** 1 files (+1/-1)
- **score 13** - ready to cherry-pick
- **triage:** bugfix | value 4 | effort 1 | risk 1 | applies likely | IMPORT
- **why:** Prevents the tree view from jumping to a matching node (like 'Research') when the search text is empty or shows the 'Search' placeholder.
...
### `20245100e0` 外部工具增加可供使用的新变量：%GUID%

- **fork:** [Hovn/mRemoteNG](https://github.com/mRemoteNG/mRemoteNG/commit/20245100e0423262d8e4b3b1a714db56a1ad2289) by Hovn
- **size:** 1 files (+4/-0)
- **score 10** - worth doing, needs work
- **triage:** feature | value 3 | effort 1 | risk 1 | applies likely | IMPORT
- **why:** Adds %GUID% variable support in external tool arguments, resolving to connection's ConstantID. Trivial, useful feature with zero risk.
- **pre-approval:** **PRE-APPROVED** (codex:REJECT / gemini:APPROVE / grok:APPROVE)
  - dissent - codex: REJECT - The capability is plausible and absent, but this fork maintains token discoverability and exhaustive parser coverage; require a complete menu-and-test patch.
