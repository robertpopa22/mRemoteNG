# mRemoteNG — Developer Guide

> This file contains orchestrator operations, release workflows, IIS system,
> PR history, and other content relevant to **human developers** and the orchestrator controller.
> For build/test/code rules, see the main [`CLAUDE.md`](../CLAUDE.md).
